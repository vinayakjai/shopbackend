...
const { createProduct, searchProductInfo, searchProductName, getAllProducts, updateNameOfProduct, updatePurchaseRate, updateMinimum_Sel_Rate, updatePriceOfGivenWeight, addNewWeightItemOgGivenProduct } = require('../controller');
